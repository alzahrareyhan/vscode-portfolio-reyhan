...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Reyhan Nandita Al Zahra',", type: 'array-item' },
    { code: "    role: 'Data Scientist','AI Engineer','ML Engineer',", type: 'array-item' },
    { code: "    bio: 'Developing predictive models and analytics'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Reyhan Nandita Al<span className={styles.accentText}> Zahra</span>
          </h1>

          <div className={styles.developerRole}>Data Scientist, AI Engineer, ML Engineer</div>

          <p className={styles.bio}>
            I build data-driven, intelligent solutions using machine learning and AI technologies. 
            Focused on clean, scalable code and delivering impactful insights through advanced 
